...
public class EffectTakeMoney extends Effect {
    ...
    protected void execute(Event event) {
        ...
        if (amountValue != null && currencyName != null && targetPlayer != null) {
            pwingEco.getCurrencyManager().getCurrency(currencyName).ifPresent(curr -> 
                pwingEco.getEconomyManager().withdrawPlayer(targetPlayer.getUniqueId(), curr, amountValue.doubleValue())
            );
        }
    }
